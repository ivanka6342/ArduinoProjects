...
int arr_7_14_left [] = {195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207};
module line_7_14_left = {LINE_DELAY, 13, arr_7_14_left};       // D-39 -> D-66 // left
int arr_7_14_right [] = {208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220};
module line_7_14_right = {LINE_DELAY, 13, arr_7_14_right};     // D-39 -> D-66 // right
int arr_14_7_left [] = {221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234};
module line_14_7_left = {LINE_DELAY, 14, arr_14_7_left};       // D-66 -> D-39 // left
int arr_14_7_right [] = {235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248};
module line_14_7_right = {LINE_DELAY, 14, arr_14_7_right};     // D-66 -> D-39 // right
