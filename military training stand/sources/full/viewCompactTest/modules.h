...
#define _MODULES_
	...
	// LINES x70 = 614B in range [250;863]
	...
	const uint16_t line_14_RK_right_red = 803;          // D-66 -> RK(right) // red
	const uint16_t line_14_RK_left_blue = 806;          // D-66 -> RK(left) // blue
	const uint16_t line_14_RK_right_blue = 809;         // D-66 -> RK(right) // blue
	
	const uint16_t line_RK_14_left_red = 812;           // RK(left) -> D-66 // red
	const uint16_t line_RK_14_right_red = 815;          // RK(right) -> D-66 // red
	const uint16_t line_RK_14_left_blue = 818;          // RK(left) -> D-66 // blue
	const uint16_t line_RK_14_right_blue = 821;         // RK(right) -> D-66 // blue
	
	const uint16_t line_14_P_296_left_red = 824;        // D-66 -> P-296(left) // red
	const uint16_t line_14_P_296_right_red = 827;       // D-66 -> P-296(right) // red
	const uint16_t line_14_P_296_left_blue = 830;       // D-66 -> P-296(left) // blue
	const uint16_t line_14_P_296_right_blue = 833;      // D-66 -> P-296(right) // blue
	
	const uint16_t line_14_PTRK_10x2_left_red = 836;    // D-66 -> PTRK 10x2(left) // red
	const uint16_t line_14_PTRK_10x2_right_red = 843;   // D-66 -> PTRK 10x2(right) // red
	const uint16_t line_14_PTRK_10x2_left_blue = 850;   // D-66 -> PTRK 10x2(left) // blue
	const uint16_t line_14_PTRK_10x2_right_blue = 857;  // D-66 -> PTRK 10x2(right) // blue
